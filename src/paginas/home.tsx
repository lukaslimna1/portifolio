...
function Home() {
  ...
  const handleDesignClick = () => {
    navigate("/trabalhos?categoria=Design");
  };

  const handleDevClick = () => {
    navigate("/trabalhos?categoria=Dev");
  };
            ...
            <div className='home-titulos'>
              <div className='home-titulos-principal'>
                <h1 className='home-titulos-principalh1'>
                  <span className='principal'>D</span>esenvolvedor <br /> FullStack |
                  Design
                </h1>
              ...
              <div className='home-titulos-secundarios'>
                <div className='home-titulos-FD'>
                  <h3 className='home-titulo-auxh3'>
                    {" "}
                ...
                <div className='home-titulos-HE'>
                  ...
                  <p className='home-titulo-auxp'>
                    "Experiência em desenvolvimento Full Stack e design de interfaces, com
                    um histórico de criação de produtos digitais eficazes e visualmente
                    atraentes."
                  </p>
                </div>
              </div>
              ...
              <div className='home-info'>
                <div className='home-info1'>
                  ...
                  <p className='home-infop'>
                    ...
                    impactantes. Com formação técnica em Assistência de Produção Gráfica e
                    Web Design, minha paixão está em otimizar estilos e layouts para
              ...
              <div className='home-info'>
                ...
                <div className='home-info2'>
                  ...
                  <p className='home-infop'>
                    ...
                    Desenvolvimento Full Stack, uso ferramentas e tecnologias como
                    React.Js, Node.Js e MySQL para criar soluções ágeis e escaláveis. Meu
                    objetivo é entregar aplicações eficientes, priorizando desempenho e
                    escalabilidade."
                  </p>
                </div>
              </div>
          ...
          <div className='home-formacao'>
            <div className='home-formacao-texto'>
              ...
              <p className='home-formacaop'>
                ...
                desde a criação de interfaces gráficas até o desenvolvimento de aplicações
                web completas. Com cursos em Desenvolvimento Full Stack, Web Design e
                Assistência de Produção Gráfica, estou preparado para construir soluções
                digitais eficazes e impactantes.
              </p>
              <p className='home-formacaop'>
              ...
              <p className='home-formacaop'>
                Em minha jornada, tenho me dedicado a aprender e aplicar conceitos de
                UX/UI para desenvolver interfaces intuitivas e de alta qualidade, sempre
                com o compromisso de entregar soluções que atendam às necessidades e
            ...
            <div className='home-link'>
              ...
              <div className='home-link-direito'>
                <div className='home-link-textos'>
                  ...
                  <p className='home-linkp'>
                    "Crio interfaces e telas para aplicativos e soluções digitais,
                    tornando cada projeto funcional e visualmente marcante."
                  </p>
                </div>
                <div className='home-link-btn'>
                  <button
